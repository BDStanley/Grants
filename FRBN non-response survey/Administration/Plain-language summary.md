...
1. **One survey, two contact protocols.** A Polish online panel agency will invite a large random sample to a ~10-minute survey on politics and society. Half the invitees (chosen at random) get an insistent treatment: an invitation plus three reminders. The other half get a single invitation and nothing else. Roughly 2,200 people will complete the survey. Every completed interview is tagged with its protocol and with the reminder that produced it.
