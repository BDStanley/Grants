...
- **Ok. 2000 zrealizowanych ankiet** z polskiego panelu CAWI; ok. 18 500 zaproszeń dzielonych losowo w proporcji 42/58 na kontakt **intensywny** (zaproszenie + trzy przypomnienia) i **lekki**; agencja oznacza każdy wywiad ramieniem i falą przypomnienia.
...
- Rezultat: dla każdego konstruktu — **jak silnie skłonność do odpowiedzi wiąże się z jej treścią, wraz z przedziałem** — oraz **zwalidowany protokół wielokrotnego użytku** dla PGSW i wielkości efektów potrzebne badaniu w pełnej skali.

## Co pilotaż tej wielkości rozstrzygnie, a czego nie {.smaller}

- Analizę zbudowaliśmy i uruchomiliśmy **na danych symulowanych, zanim ruszy badanie** — i tak właśnie odkryliśmy, że przy dwóch przypomnieniach kluczowe testy wykrywałyby spodziewane efekty mniej więcej **raz na dziesięć prób**.
- Wiążącym ograniczeniem jest **różnica odsetków odpowiedzi**, a nie liczba wywiadów: próba daje √n, protokół kontaktu daje różnicę. Stąd trzy przypomnienia i próg „idziemy / nie idziemy" po miękkim starcie ustawiony na mocy testu, a nie na poprawności instrumentu.
- Mimo to: część pytań wróci jako **nierozstrzygnięte**. Uczciwym produktem jest oszacowanie z przedziałem, a nie werdykt przy każdym pytaniu.
- I po to właśnie robi się pilotaż — a to dokładnie to, czego potrzebuje wniosek NCN OPUS, żeby mieć odpowiednią moc.
